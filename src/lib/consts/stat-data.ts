...
export const SUBSTAT_OPTIONS: SubstatOption[] = [
    ...
    { label: '生命%', tiers: [6.4, 7.1, 7.9, 8.6, 9.4, 10.2, 10.9, 11.6], unit: '%' },
    { label: '攻击%', tiers: [6.4, 7.1, 7.9, 8.6, 9.4, 10.2, 10.9, 11.6], unit: '%' },
    ...
    { label: '普攻伤害加成', tiers: [6.4, 7.1, 7.9, 8.6, 9.4, 10.2, 10.9, 11.6], unit: '%' },
    { label: '重击伤害加成', tiers: [6.4, 7.1, 7.9, 8.6, 9.4, 10.2, 10.9, 11.6], unit: '%' },
    { label: '共鸣技能伤害加成', tiers: [6.4, 7.1, 7.9, 8.6, 9.4, 10.2, 10.9, 11.6], unit: '%' },
    { label: '共鸣解放伤害加成', tiers: [6.4, 7.1, 7.9, 8.6, 9.4, 10.2, 10.9, 11.6], unit: '%' }
] as const
